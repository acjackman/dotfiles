virtualenvwrapper='pyenv virtualenvwrapper'
virtualenvwrapper_lazy='pyenv virtualenvwrapper_lazy'
...
if (( $+commands[$virtualenvwrapper_lazy] )); then
  ...
  # print "[oh-my-zsh] virtualenvwrapper plugin: Using Python $(which pyenv).\n" >&2
  return
fi
